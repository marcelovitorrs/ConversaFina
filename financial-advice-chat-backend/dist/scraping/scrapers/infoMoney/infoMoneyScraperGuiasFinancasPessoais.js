...
exports.scrapeInfomoneyGuiaFinancasPessoais = void 0;
const puppeteer_1 = __importDefault(require("puppeteer"));
const cheerio = __importStar(require("cheerio"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const scrapeInfomoneyGuiaFinancasPessoais = () => __awaiter(void 0, void 0, void 0, function* () {
    const url = "https://www.infomoney.com.br/trilha/financas-pessoais/";
    try {
        ...
        const filePath = path.join(dataDir, "infomoney_guia_financas_pessoais.json");
...
exports.scrapeInfomoneyGuiaFinancasPessoais = scrapeInfomoneyGuiaFinancasPessoais;
