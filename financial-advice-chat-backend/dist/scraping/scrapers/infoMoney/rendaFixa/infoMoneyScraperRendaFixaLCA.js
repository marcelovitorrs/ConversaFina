...
exports.scrapeInfomoneyLCA = void 0;
const puppeteer_1 = __importDefault(require("puppeteer"));
const cheerio = __importStar(require("cheerio"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
const scrapeInfomoneyLCA = () => __awaiter(void 0, void 0, void 0, function* () {
    const url = "https://www.infomoney.com.br/tudo-sobre/lca/";
    try {
        ...
        const filePath = path.join(dataDir, "infomoney_lca.json");
...
exports.scrapeInfomoneyLCA = scrapeInfomoneyLCA;
